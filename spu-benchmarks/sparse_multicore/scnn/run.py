...
# cases.append(("alexconv1", 3, 224, 224, 28, 28, 192, 1, 5, 5)) # Tn=20?
...
for n, Ni, Nx, Ny, Tx, Ty, Nn, Tn, Kx, Ky in cases:
    ...
    # TODO: make it layer name
    log_file = 'logs/%s.log' % (w1)
    f = open(log_file,'w+')
    f.write('%s' %raw)
    f.close()
...
#     "datasets/very_small/act_ptr.data", 1, 10, 10, 10, 10, 1, 1, 3, 3))
