...
function run_test {
  ...
  BACKCGRA=1 LINEAR_SCR=1 gem5.opt /home/vidushi/ss-stack/gem5/configs/example/se.py --cpu-type=MinorCPU --l1d_size=2048kB --l1i_size=16kB --caches --ruby --num-cpus=8 --num-dirs=1 --network=simple --topology=Mesh_XY --mesh-rows=2 --cmd=$test
